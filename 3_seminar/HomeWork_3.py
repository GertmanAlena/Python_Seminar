...
# numbers = random_numb.Random_Number(-10,10,7)
# print(numbers)
...
# import random_numb
# First_List = random_numb.Random_Number(1, 100, 10)
...
# Spisok_Numbers = [1.1, 1.2, 3.1, 5.17, 10.02] 
...
#    если максимальное число <10 добавляем ноль
#    и вычисляем разницу
#    '''
#    raznica=0
